...
export default function Component() {
	...
	return (
		<div className="flex flex-col min-h-[100dvh]">
			<header className="bg-background px-4 lg:px-6 py-4 flex items-center justify-between shadow-sm">
				...
				<nav className="hidden md:flex items-center gap-6">
					<Link
						...
						onClick={() =>
							(window.location.href = "#we-are-building")
						}
				...
				<Button
					size="sm"
					className="md:hidden hover:bg-primary hover:text-primary-foreground font-bold"
				>
					Menu
				</Button>
			</header>
					...
					<div className="container px-4 md:px-6 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
						<div className="space-y-4 md:space-y-6">
							...
							<p className="text-lg md:text-xl text-[#5C2018]">
								...
								with our premium fashion delivery service. Try
								on the latest trends in the comfort of your own
								home.
							</p>
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
							<div className="bg-white rounded-lg shadow-md p-4 md:p-6 space-y-2">
								...
								<p className="text-muted-foreground">
									Browse our selection of the latest fashion
									trends and add your desired items to your
									cart.
								</p>
							</div>
							<div className="bg-white rounded-lg shadow-md p-4 md:p-6 space-y-2">
								...
								<p className="text-muted-foreground">
									...
									doorstep within 2 hours, free of charge.
								</p>
							</div>
							<div className="bg-white rounded-lg shadow-md p-4 md:p-6 space-y-2">
								...
								<p className="text-muted-foreground">
									Try on the items in the comfort of your own
									home and decide what you want to keep.
								</p>
							</div>
						</div>
					</div>
				...
				>
					<div className="container px-4 md:px-6 text-center space-y-4 md:space-y-6">
						...
						<div className="flex justify-center gap-2">
							...
							/>
							<Button onClick={onSubscribeClickHandler}>
								Subscribe
							</Button>
						</div>
						{errorMessage && (
							...
							<Collapsible>
								<CollapsibleTrigger className="flex items-center justify-between w-full bg-muted p-4 rounded-lg">
									<h3 className="text-lg font-medium">
										...
										What is the delivery time for your
										service?
									</h3>
								</CollapsibleTrigger>
								<CollapsibleContent className="bg-muted p-4 rounded-lg">
									<p className="text-muted-foreground">
										We offer a 2-hour delivery service for
										all orders placed within our delivery
										area. Our team works hard to ensure your
										items arrive quickly and in perfect
										condition.
									</p>
								</CollapsibleContent>
							</Collapsible>
							...
							<Collapsible>
								...
								<CollapsibleContent className="bg-muted p-4 rounded-lg">
									<p className="text-muted-foreground">
										...
										cards, as well as UPI and Cash on Delivery. 
									</p>
								</CollapsibleContent>
							</Collapsible>
						</div>
			...
			<section
				id="contact-info"
				className="bg-white py-6 md:py-12 lg:py-16"
			>
					...
					<div className="grid grid-cols-1 gap-2">
						...
						<div className="grid grid-cols-[100px_1fr] gap-2">
							...
							<p>
								...
								B-514, Sree Utopia Apartments, Kadubeesanahalli,
								Bangalore 560103
							</p>
						</div>
					</div>
			...
			<footer className="bg-background px-4 md:px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-4 border-t">
				<p className="text-sm text-muted-foreground">
					&copy; 2024 The Fashion Fleet. All rights reserved.
				</p>
			</footer>
		</div>
	);
